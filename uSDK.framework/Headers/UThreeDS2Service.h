...
- (nullable id<UTransaction>)createTransaction:(nonnull NSString *)directoryServerID
                                messageVersion:(nullable NSString *)messageVersion DEPRECATED_MSG_ATTRIBUTE("Use createTransaction:spec instead");
...
- (nullable id<UTransaction>)u_createTransaction:(nonnull NSString *)directoryServerID
                                  messageVersion:(nullable NSString *)messageVersion
                                           error:(NSError *__autoreleasing  _Nullable *_Nullable)error DEPRECATED_MSG_ATTRIBUTE("Use createTransaction:spec instead");
